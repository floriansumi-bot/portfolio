...
const PROJECTS_BASE = [
  { name: "THE CONSTRUCT", emoji: "🧩", grad: "linear-gradient(135deg, #06b6d4, #7c3aed)", status: "live",
  ...
  { name: "The Loop Academy", emoji: "🔁", grad: "linear-gradient(135deg, #22d3ee, #6d28d9)", status: "live",
    tech: ["JavaScript", "AI agents", "PWA", "Vercel"],
    live: "https://loop-academy.vercel.app/", repo: "" },
  { name: "SheetGenie", emoji: "📊", grad: "linear-gradient(135deg, #16a34a, #22d3ee)", status: "dev",
    tech: ["Vanilla JS", "Python", "openpyxl", "Vercel", "Multimodal AI"],
    live: "", repo: "https://github.com/floriansumi-bot/sheetgenie" },
  { name: "Flaily", emoji: "📬", grad: "linear-gradient(135deg, #6d28d9, #0891b2)", status: "live",
    tech: ["AI agent", "Gmail", "PWA", "GitHub Pages"],
    live: "https://floriansumi-bot.github.io/flaily/", repo: "" },
  { name: "AdForge", emoji: "🎨", grad: "linear-gradient(135deg, #f59e0b, #8b5cf6)", status: "dev",
    tech: ["Multi-agent AI", "JavaScript", "Image generation"],
    live: "", repo: "" },
  { name: "SAPE", emoji: "🛍️", grad: "linear-gradient(135deg, #f472b6, #8b5cf6)", status: "dev",
    tech: ["Node", "Express", "JWT auth", "PWA", "JSON DB"],
    live: "", repo: "" },
  { name: "HyperFractal", emoji: "🌀", grad: "linear-gradient(135deg, #8b5cf6, #ec4899)", status: "dev",
    tech: ["WebGL", "Canvas", "Web Audio", "JavaScript"],
    live: "", repo: "" },
  { name: "Barathon", emoji: "🍻", grad: "linear-gradient(135deg, #f59e0b, #f472b6)", status: "dev",
    tech: ["React Native", "Expo", "Supabase"],
    live: "", repo: "" },
  { name: "Trading Assistant", emoji: "📈", grad: "linear-gradient(135deg, #22d3ee, #16a34a)", status: "research",
...
const CONTENT = {
  en: {
    ...
    ui: {
      ...
      "hero.pitch": "A humanities student who ships real software. I turn ideas into working apps — an in-browser school that teaches six programming languages, a prompt-to-Excel generator, a resale marketplace and more. Native French & English.",
  ...
  zh: {
    ...
    "ui": {
      ...
      "hero.pitch": "一名能交付真实软件的人文学科学生。我把想法变成可用的应用——一所在浏览器里教你六种编程语言的学校、一个把文字生成 Excel 的工具、一个二手交易市场，以及更多。母语 法语 & 英语。",
  ...
  ja: {
    ...
    "ui": {
      ...
      "hero.pitch": "実際に動くソフトウェアを世に出す人文系の学生です。アイデアを動くアプリへと形にします — 6つのプログラミング言語を学べるブラウザ内スクール、プロンプトから Excel を生成するツール、リセールマーケットプレイスなど。フランス語・英語ネイティブ。",
      "hero.cta.work": "実績を見る",
