...
const CONTENT = {
  ...
  "de": {
    ...
    "ui": {
      ...
      "hero.role": "Ich entwickle echte Web-Apps — 8 davon live",
      "hero.pitch": "Ich mache aus Ideen Software, die Menschen wirklich nutzen — 8 davon sind genau jetzt online: eine Schule im Browser, die sechs Programmiersprachen unterrichtet, ein Generator, der aus einem einzigen Satz eine Excel-Datei erstellt, eine Begleiter-App mit echtem Gedächtnis und vieles mehr. Aus der Medienforschung kommend, baue ich für echte Menschen — nicht nur für andere Ingenieure. Französisch und Englisch als Muttersprache; Schweizer und US-Amerikaner.",
  ...
  "zh": {
    ...
    "ui": {
      ...
      "hero.role": "我打造真实可用的 Web 应用——已有 8 款上线",
      "hero.pitch": "我把想法变成人们真正会用的软件，其中 8 款此刻就在线上运行：一所在浏览器里教六种编程语言的学校、一个把一句话变成 Excel 文件的生成器、一个拥有真实记忆的陪伴应用，等等。我来自媒体研究背景，为真实的人而设计——而不仅仅是为其他工程师。法语和英语母语；瑞士与美国双重国籍。",
  ...
  "ja": {
    ...
    "ui": {
      ...
      "hero.role": "本物の Web アプリを開発 — 8本が公開中",
      "hero.pitch": "アイデアを、人が実際に使うソフトウェアに変えています。そのうち8本は今この瞬間も公開中です — 6つのプログラミング言語を教えるブラウザ内スクール、一文から Excel ファイルを生成するツール、本物の記憶を持つコンパニオンアプリなど。メディア研究の出身として、他のエンジニアのためだけでなく、実際の人々のために設計しています。フランス語と英語のネイティブ；スイスとアメリカの国籍。",
      "hero.cta.work": "実績を見る",
